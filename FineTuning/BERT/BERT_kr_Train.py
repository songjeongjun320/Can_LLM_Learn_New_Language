...
# --- 설정 ---
DATA_DIR = "/scratch/jsong132/Can_LLM_Learn_New_Language/FineTuning/BERT/KR_ENG_Dataset_Refined" # 데이터셋 디렉토리
MODEL_NAME = "bert-base-uncased" # 사용할 BERT 모델
OUTPUT_DIR = "./bert-uncased-finetuned-kr-eng" # 파인튜닝된 모델 저장 경로
...
MAX_SEQ_LENGTH = 256 # 입력 시퀀스 최대 길이 (BERT는 보통 512)
