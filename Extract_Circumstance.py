###############################################
# Extract the circumstance from the Circumstance
################################################

import requests
import ollama
# Ollama 서버 설정
ollama_host = "http://sg028:11434"
...
Guess what kind of conversation might typically occur in this situation. Ignore all text visible in the Circumstance.
